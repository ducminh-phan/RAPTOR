...
private:
    ...
    std::unordered_map<stop_id_t, Time> m_earliest_arrival_time;
    std::unordered_map<stop_id_t, std::vector<Time>> m_labels;
...
using cache_key_t = std::tuple<Time::value_type, route_id_t, stop_id_t>;
